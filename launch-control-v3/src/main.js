...
async function startup() {
  ...
  // 2. Load ticker universe — equity_profiles only for WebSocket (Alpaca caps at ~200 symbols)
  //    conviction_universe tickers get data via REST snapshots in the poller
  ...
  logger.info(`✓ Loaded ${tickers.length} profile tickers for WebSocket subscriptions`);
